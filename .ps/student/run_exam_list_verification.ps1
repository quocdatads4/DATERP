...
$verificationScript = "C:\Users\QuocDat-PC\Documents\GitHub\DATERP\.agent\automation\student\verify_student_exam_list.js"
...
# Run verification
Write-Host "`n=== Step 5: Running Selenium Verification ===" -ForegroundColor Cyan
