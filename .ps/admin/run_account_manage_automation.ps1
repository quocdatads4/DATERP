# Automation script for Account Manage page testing
...
# 5. Chạy automation script cho Account Manage
Write-Host "Running Account Manage verification script..." -ForegroundColor Yellow
node verify_account_manage.js
