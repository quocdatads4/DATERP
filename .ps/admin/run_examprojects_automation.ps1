# Script to build and run DATERP then verify ExamProjects page

Write-Host "=== EXAM PROJECTS PAGE AUTOMATION ===" -ForegroundColor Cyan
...
node verify_examprojects_page.js

Write-Host "=== AUTOMATION FINISHED ===" -ForegroundColor Green
Read-Host -Prompt "Press Enter to stop server and exit"
